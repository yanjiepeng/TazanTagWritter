...
public class WriteActivity extends Activity {
     ...
     * Package Key.
     */
    static String packageKey = "secretkey";
    /**
     * byte array.
     */
    byte[] data;
    ...
    private void initializeView() {
        ...
        information_textView = (TextView) findViewById(R.id.text_info);
    ...
    private void initializeKeys() {
        ...
        try {
            ...
            ((ActivityManager) WriteActivity.this.getSystemService(ACTIVITY_SERVICE))
...
//                break;
    ...
    private void desfireLightCardLogic(IDESFireLight idesFireLight) {
        ...
        try {
            ...
            mStringBuilder.append(getString(R.string.Data_to_write)).append(
                    Utilities.dumpBytes(data));
            mStringBuilder.append("\n\n");
            idesFireLight.writeData(00, 0, data);
            mStringBuilder.append(getString(R.string.Data_written_successfully));
            mStringBuilder.append("\n\n");
            mStringBuilder.append(getString(R.string.Data_read_from_the_card)).append(
                    Utilities.dumpBytes(idesFireLight.readData(00, 0, data.length)));
            mStringBuilder.append("\n\n");
            showMessage(mStringBuilder.toString(), PRINT);
    ...
    private void ntag413CardLogic(final INTag413DNA tag) {
        byte[] writeDataByte = new byte[]{01, 02, 03, 04, 05, 06, 01, 02, 03, 04, 05, 06};
        byte[] readDataByte;
        ...
        try {
            ...
            mStringBuilder.append("\n\n");
            tag.writeData(02, 0, writeDataByte);
            mStringBuilder.append(getString(R.string.Data_written_successfully));
            mStringBuilder.append("\n\n");
            readDataByte = tag.readData(02, 00, writeDataByte.length);
            mStringBuilder.append(getString(R.string.Data_read_from_the_card)).append(
    ...
    private void tag424DNACardLogic(INTAG424DNA ntag424DNA) {
        ...
        byte[] data = { (byte) 0xA0, 0x00, 0x00, 0x03, (byte) 0x96, 0x56, 0x43, 0x41, 0x03, (byte) 0xF0, 0x15, 0x40, 0x00,
                0x00, 0x00, 0x0B, (byte) 0xA0, 0x00, 0x00, 0x03, (byte) 0x96, 0x56, 0x43, 0x41, 0x03, (byte) 0xF0, 0x15,
                0x40, 0x00, 0x00, 0x00, 0x0B };
        mStringBuilder.append(getString(R.string.Card_Detected)).append(
        ...
        try {
            ...
            mStringBuilder.append("\n\n");
            mStringBuilder.append(getString(R.string.Data_read_from_the_card)).append(
                    Utilities.dumpBytes(ntag424DNA.readData(03, 0, data.length)));
            mStringBuilder.append("\n\n");
            showMessage(mStringBuilder.toString(), PRINT);
            //To save the logs to file \sdcard\NxpLogDump\logdump.xml
            NxpLogUtils.save();
    ...
    private void tag424DNATTCardLogic(INTAG424DNATT ntag424DNATT) {
        ...
        try {
            ...
            mStringBuilder.append(getString(R.string.Data_to_write)).append(
                    Utilities.dumpBytes(data));
            mStringBuilder.append("\n\n");
            ntag424DNATT.writeData(03, 0, data);
            mStringBuilder.append(getString(R.string.Data_written_successfully));
            mStringBuilder.append("\n\n");
            mStringBuilder.append(getString(R.string.Data_read_from_the_card)).append(
                    Utilities.dumpBytes(ntag424DNATT.readData(03, 0, data.length)));
            mStringBuilder.append("\n\n");
            showMessage(mStringBuilder.toString(), PRINT);
            //To save the logs to file \sdcard\NxpLogDump\logdump.xml
            NxpLogUtils.save();
